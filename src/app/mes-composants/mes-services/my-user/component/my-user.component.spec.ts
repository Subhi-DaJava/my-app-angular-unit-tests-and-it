...
describe('MyUserComponent', () => {
  ...
  beforeEach(async () => {
    ...
    serviceMock = TestBed.inject(MonService);
  ...
  it('should getUsers return users', () => {
    ...
    const sypService = jest.spyOn(serviceMock, 'getUsers').mockReturnValue(of(users));

    component.getUsers();
    fixture.detectChanges();
    expect(component.users).toEqual(users);
    expect(sypService).toHaveBeenCalled();
    expect(sypService).toHaveBeenCalledTimes(1);
